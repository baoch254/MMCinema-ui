...
export {getNowShowingMoviews, getUpcomingMovies} from './utils-functions/date-categorizer'
...
export {default as getCinemaRoomFromId} from './utils-functions/getCinemaRoomFromId'
