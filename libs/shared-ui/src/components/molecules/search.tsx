...
import { cn, Button } from '@mmcinema-ui/shadcn';
import { useSearch } from '@mmcinema-ui/shared-providers';
import { CommandMenu } from '../organisms/command-menu';
...
export function Search({ className = '', placeholder = 'Search', isMain = false }: Props) {
